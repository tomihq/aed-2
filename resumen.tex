...
\begin{center}
    ...
    \end{minipage}
\end{center}
Viendo la figura de la derecha, no está balanceado: porque la rama de la izquierda del 10 son 3 nodos y la derecha 1, y difieren en 2 nodos, por lo tanto no está balanceado. \\
