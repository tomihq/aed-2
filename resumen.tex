...
Terminología variada que vamos a usar en la materia:
raíz, hoja aunque existen otras. \\ 
Para poder obtener un elemento de un árbol se debe empezar por la raíz y recorrer cada una de las hojas recursivamente hasta que se encuentre. \\ \\
