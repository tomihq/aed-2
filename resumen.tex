...
Es un algoritmo de ordenamiento que no utiliza comparaciones. Solo acepta arreglos de números naturales y cuando el rango de los elementos es pequeño en comparación con el número de elementos a ordenar.
\begin{itemize}
    \item Busco el máximo elemento del arreglo original, y creo un arreglo vacío con longitud del máximo elemento.
    \item Cada aparición de un elemento hace referencia a incrementar uno el índice que representa ese valor.
    \item Luego, recorremos el array nuevamente pero ahora la cantidad de elementos en ese índice es la cantidad de repeticiones del número.
\end{itemize}
\begin{lstlisting}
