...
Es una técnica de ordenamiento que consiste en dividir elementos en varios grupos o baldes (buckets). Los elementos forman los buckets distribuyéndose uniformemente, además de ser comparables entre sí. Una vez que tenemos los buckets, podemos utilizar cualquier algoritmo de ordenamiento para ordenar. Por último, se reúnen de forma ordenada.
\section*{Anexo}
