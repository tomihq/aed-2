...
Véase \hyperref[subsec:cola_de_prioridad_avl]{anexo} para un ejercicio de elección de estructuras para armar una cola de prioridad.
\section*{Heaps}
...
Véase \hyperref[subsec:implementaciones_heap]{implementaciones heaps} de maneras diversas.
