    ...
    Módulo RelacionadosImpl<T1, T2> implementa Relacionados<T1, T2> {
        ...
        proc relacionar(inout r: RelacionadosImpl<T1, T1>, in t1:T1, in t2:T2){
            ...
            if(t1obj == true) then 
                ...
                r.rt1.definirRapido(t1, new ConjuntoLog().definirRapido(t2)); //O(log n)
            endif 
            ...
            if(t2obj == true) then 
                ...
                r.rt2.definirRapido(t2, new ConjuntoLog().definirRapido(t1)); //O(log m)
            endif 
        }

        O(log n + log m + (log n + log m + log m + log n) + (log m + log n + log n + log m)) =
        O(log n + log m)
    }
