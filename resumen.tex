...
\section*{Tries}
El Trie es una estructura de datos que se suele utilizar en autocompletado de texto, pattern matching, etc. No tiene ciclos, debe pensarse recursivamente. \\
\begin{itemize}
    \item Los nodos internos no tienen un valor.
    \item Los valores de los nodos se almacenan solamente en hojas (a veces ni eso).
\end{itemize}
\begin{center}
    \begin{minipage}[b]{0.5\textwidth}
        \includegraphics[width=\linewidth]{assets/trie.png}
        \centering
        \label{fig:trie}
    \end{minipage}
\end{center}
Propiedades:
\begin{itemize}
    \item Cuando llego a una hoja es una palabra
