...
\begin{lstlisting}
    ...
    proc desapilar(inout p': PilaConElimArr<T>): T{
        ...
        var nuevoArreglo: Array<T> := new Array<T>(){p'.largo-1};
        var nuevoArregloEnUso:Array<boolean> := new Array<T>(){p'.largo-1}; //Se inicializa todo en false

        while(i<nuevoArreglo.length) do //Coloco los n-1 elems.
            nuevoArreglo[i] = p'.datos[i];
            nuevoArregloEnUso[i] = p'.enUso[i];
        endwhile;
