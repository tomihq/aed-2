...
Es un algoritmo eficiente que está diseñado para ciertos tipos de datos y situaciones muy particulares. Los elementos se distribuyen en buckets (cajas) donde cada caja se ordena individualmente, generalmente utilizando otro algoritmo de ordenamiento o aplicando recursivamente bucket sort si es necesario.
\begin{itemize}
